...
Lightning Models provides mixin classes that simplify pushing models to
and pulling models from the registry. These mixins can be integrated
directly into the model classes.

Available Mixins
~~~~~~~~~~~~~~~~

1. **PickleRegistryMixin**: For serializing any Python class with pickle
2. **PyTorchRegistryMixin**: For PyTorch models, preserving both weights
